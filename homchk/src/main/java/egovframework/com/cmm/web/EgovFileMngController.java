...
public class EgovFileMngController {
    ...
    @RequestMapping("/cmm/fms/selectImageFilePhotoList.do")
    public String selectImageFilePhotoList( @ModelAttribute("searchVO") FileVO fileVO
    									  , @RequestParam Map<String, Object> commandMap,
	    //SessionVO sessionVO,
	    ModelMap model) throws Exception {

		String atchFileId = (String)commandMap.get("atchFileId");
		String callTp = (String)commandMap.get("callTp");
		String idx = (String)commandMap.get("idx");
		String facilitiesNm = (String)commandMap.get("facilitiesNm");

		fileVO.setAtchFileId(atchFileId);
		List<FileVO> result = fileService.selectImageFileList(fileVO);

		model.addAttribute("fileList", result);
		model.addAttribute("callTp", callTp);
		model.addAttribute("idx", idx);
		model.addAttribute("facilitiesNm", facilitiesNm);


		return "homchk/inc/homchkPhotoList";
    }
}
